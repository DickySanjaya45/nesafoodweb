...
final List<Menu> _kantinA = [
  ...
  Makanan(
    ...
    image: _ph,
    price: 25000,
    description: 'Potongan rendang empuk.',
  ),
  Makanan(
...
final List<Kantin> kantinList = [
  ...
  Kantin(name: 'Kantin Dina', image: 'assets/kantin_d.png', menus: _kantinD),
  Kantin(name: 'Kantin Paijo', image: 'assets/kantin_e.png', menus: _kantinE),
  Kantin(name: 'Kantin F', image: 'assets/kantin_f.png', menus: _kantinF),
  Kantin(name: 'Kantin G', image: 'assets/kantin_g.png', menus: _kantinG),
  Kantin(name: 'Kantin H', image: 'assets/kantin_h.png', menus: _kantinH),
  Kantin(name: 'Kantin I', image: 'assets/kantin_i.png', menus: _kantinI),
  Kantin(name: 'Kantin J', image: 'assets/kantin_j.png', menus: _kantinJ),
];
